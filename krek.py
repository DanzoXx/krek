...
#------------[ UBAH UA DIH SINI OM ]---------------#
 ...
 c=random.randrange(73,130)
 d=random.randrange(4100,5300)
 e=random.randrange(40,150)
 f=random.choice(['Samsung A20','Samsung A70','Samsung A7','samsung A56 )','Samsung A52s)','Samsung A51','Samsung A50','SM-M526B)'])
 XILL=f'Mozilla/5.0 (Linux; Android {a}; {f} Build/QCOS30.{b}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{c}.0.{d}.{e} Mobile Safari/537.36'
 uaku2 = random.choice([XILL])
 ugen.append(uaku2)
